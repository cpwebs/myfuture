<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="finance.aspx.cs" Inherits="myfuture.finance" %>
            ...
            <div class="card">
               <div class="card-body">
                  ...
                  <div class="row">
                   ...
                   <div class="row">
					<asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString='<%$ ConnectionStrings:con %>' SelectCommand="SELECT * FROM [user_tbl] WHERE member_id = @user AND type = 'Finance'">
					    <SelectParameters>
